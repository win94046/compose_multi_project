package domain.presentation.screen
...
class HomeViewModel(
    ...
    private suspend fun fetchNewRates() {
        println("HomeViewModel: fetchNewRates start")
        try {
            println("HomeViewModel: try  ")
            ...
            if (localCache.isSuccess()) {
                ...
                println("HomeViewModel: else")
            }
            getRateStatus()
        } catch (e: Exception) {
            println("HomeViewModel : e = ${e.message}")
        }
    }
    ...
    private suspend fun cacheTheData() {
        ...
        if (fetchedData.isSuccess()) {
            ...
            _allCurrencies.clear()
            fetchedData.getSuccessData().let { _allCurrencies.addAll(it) }
